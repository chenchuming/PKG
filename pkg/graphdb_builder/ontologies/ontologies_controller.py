...
from pkg.graphdb_builder import mapping as mp, builder_utils
from pkg.graphdb_builder.ontologies.parsers import * # TODO: remove star import
import os.path
import pandas as pd
import csv
...
def parse_ontology(ontology, download=True):
    ...
    """
    directory = pkg_config['ontologies_directory']
